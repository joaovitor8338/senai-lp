...
create database campeonatobrasileiro; -- criar base de 
...
update time set id_estadio = 8 where id_time = 11;
update time set id_estadio = 13 where id_time = 12;
update time set id_estadio = 1 where id_time = 13;
